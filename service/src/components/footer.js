  ...
  return (
    <Container>
        <footer className="bg-light text-center text-muted py-4 mt-5 border-top">
            ...
            <p className="mb-1">Contact us at <a href="mailto:dummymail@gmail.com">artistryhub@gmail.com</a></p>
            <p className="mb-0">© 2025 ArtistryHub. Site designed by Bella Wu, Enuma Otiji.</p>
            </div>
